          ...
          <table className="tabla">
            ...
            <tbody id="tablaProductos">
                ...
                productos.map((p) => (
                    ...
                    <td>{p.categoria || "—"}</td>
                    <td>{CLP(p.precio)}</td>
                    <td className={typeof p.stock === "number" && typeof p.stockCritico === "number" && p.stock <= p.stockCritico ? "stock-critico" : ""}>
                      {typeof p.stock === "number" ? p.stock : "—"}
                    </td>
                    {isAdmin && (
                        <td>
                            <a className="btn secundario" href={`/admin/editarProducto/${encodeURIComponent(p.codigo)}`}>Editar</a>
                        </td>
                    )}
                    </tr>
                ))
